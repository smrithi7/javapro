...
public class Tech3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface face=Typeface.createFromAsset(getAssets(), "fonts/rough.ttf");
        tv.setTypeface(face);
        tv2=(TextView)findViewById(R.id.t2);
        Typeface face2=Typeface.createFromAsset(getAssets(), "fonts/bis.ttf");
        tv2.setTypeface(face2);
        tv3=(TextView)findViewById(R.id.t3);
        Typeface face3=Typeface.createFromAsset(getAssets(), "fonts/rough.ttf");
        tv3.setTypeface(face3);
        tv4=(TextView)findViewById(R.id.t5);
        Typeface face4=Typeface.createFromAsset(getAssets(), "fonts/rough.ttf");
        tv4.setTypeface(face4);
        tv5=(TextView)findViewById(R.id.t4);
        Typeface face5=Typeface.createFromAsset(getAssets(), "fonts/bis.ttf");
        tv5.setTypeface(face5);
        tv6=(TextView)findViewById(R.id.t6);
        Typeface face6=Typeface.createFromAsset(getAssets(), "fonts/bis.ttf");
