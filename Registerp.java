...
public class Registerp extends AppCompatActivity implements View.OnClickListener {
    EditText t1,t2,t3,t4,t5;
    String s1,s2,s3,s4,s5;
    private Button b;
   // com.example.vidhya.melange.Sys e;
            ...
            public void onClick(View view) {
                ...
                if (view == b) {
                    if (awesomeValidation.validate()) {
                        ...
                        Submit();
                        Toast.makeText(Registerp.this, "submitted successfully", Toast.LENGTH_SHORT).show();


                        Intent intent = new Intent(Registerp.this, Success.class);
...
public  void Submit()
{
    ...
    private void sendEmail(StringBuffer sbf) {
        ...
        SendMail sm = new SendMail(this, "k.srimathi7@gmail.com", "Registration for Paper Presentation",sbf);
